...
export default async function Dashboard({ children }: DashboardProps) {
  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black min-w-[380px]">
      <main className="flex flex-1 w-full flex-col items-center justify-between py-16 px-4 sm:px-6 md:px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="glass-container">
          <div
            className={`grid grid-cols-1 ${session ? "lg:grid-cols-12" : ""} min-h-[600px]`}
          >
